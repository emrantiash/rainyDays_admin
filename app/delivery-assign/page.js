...
export default function Page() {
    ...
    const data = dashData.status_5_branch_wise
    console.log(data)

    useEffect(() => {
      dispatch(setbreadcrumb(["Dashboard", "Delivery-Assign"]));
    ...
    const getOrderDetails = (strid, data) => {
      const optionNext = "branch_id=" + data.id + "&status=" + 5
        ...
        dispatch(dashboardData([strid, data,"Delivery-Assign"])) 
                ...
                <div className="row">
                    <div className="d-sm-flex align-items-center justify-content-between mb-8" style={{ width: '60%', backgroundColor: '#f6f6f' }}>
                        <span
                            ...
                            style={{ padding: 10 }}
                        >
                            <Label className="badge bg-secondary text-wrap" title="Delivery-Assign" size={12} />
                        </span>
                    </div>
                                        ...
                                        <div className="card-body" style={{ cursor: 'pointer' }}>
                                            <div className="row no-gutters align-items-center">
                                                <div className="col mr-2" onClick={() =>
                                                    getOrderDetails("Delivery-Assign", data)
                                                }>

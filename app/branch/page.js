...
export default function Page() {
    ...
    const data = dashData.status_4_branch_wise

    useEffect(() => {
        dispatch(setbreadcrumb(["Dashboard", "Branch"]));
    ...
    const getOrderDetails = (strid, data) => {
        const optionNext = "branch_id=" + data.id + "&status=" + 4
        const option = "branch_id=" + data.id + "&status=" + 4
            ...
            <div className="container-fluid">
                ...
                <Dashnav />
                {
                    ...
                    <div style={{
                        ...
                        <a href="/branch-store" style={{ float: 'right' }}>Details </a>
                ...
                <div className="row">
                    <div className="d-sm-flex align-items-center justify-content-between mb-8" style={{ width: '60%', backgroundColor: '#f6f6f' }}>
                        <span
                            ...
                            style={{ padding: 10 }}
                        >
                            <Label className="badge bg-success text-wrap" title="Branch" size={12} />
                        </span>
                    </div>
